...
Hex plugin is a plugin that permit to modify any binary file... i used hex plugin many tims to modify divers binary files without need to have a compiler ... but shure not need to touch the code ... only ascii characters same in this example.
